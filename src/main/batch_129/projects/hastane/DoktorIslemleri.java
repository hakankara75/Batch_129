...
import static main.batch_129.projects.hastane.HastaIslemleri.anaMenu;

public class DoktorIslemleri extends VeriBankasi{

    static Scanner scan = new Scanner(System.in);
    public static Map<String, String> doktorListesiMap = new HashMap<>();
