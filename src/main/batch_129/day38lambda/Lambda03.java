...
public class Lambda03 {
    ...
    public static void main(String[] args) {
        ...
        List<Course> myList = coursesList.
                ...
                skip(2). // boşver demek. yani ilk 2sini es geç
        ...
        List<Course> yourList = coursesList.
                stream().
                sorted(Comparator.comparing(Course::getAverageScore)).
                limit(3). // limit de üst siniri verir. o sayiya kadarki elemanlari alir.
                collect(Collectors.toList());
        ...
        Course result5 =   coursesList.
                stream().
                sorted(Comparator.comparing(Course::getAverageScore)).
                skip(2). // ilk 2 yi es geçer
                limit(1). // 3. elemani alir.
                findFirst().
                get();
